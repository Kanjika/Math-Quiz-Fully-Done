...
function send()
{
	...
	answer = "<br><br><button class = 'btn btn-success' onclick = 'answer()'>What is the answer?</button>"
...
function check()
{
	...
	if(get_answer == actual_answer)	
	{
		...
		document.getElementById("output").innerHTML = "Your answer is correct! Well done!"
		document.getElementById("output").style.color = "green"
		document.getElementById("output").style.fontsize = "25px";
	}
	else{
		 first = document.getElementById("output").innerHTML = "Your answer is wrong<br> The actual answer is - " + number1 * number2;
